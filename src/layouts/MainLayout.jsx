  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#171717] text-brand-50">
      ...
      <footer className="border-t border-white/10 bg-brand-900/90">
        <div className="mx-auto flex max-w-6xl flex-col gap-3 px-6 py-6 text-sm text-slate-200 md:flex-row md:items-center md:justify-between">
          <div>
          ...
          <div className="flex flex-wrap items-center gap-4 text-slate-200">
            <span>Serving New England</span>
            <span className="font-semibold text-white">Call {contactInfo.phone}</span>
